...
urlpatterns = [
    ...
    path('api_eliminar_solicitud_partida/<int:pk>/', views.SolicitudPartidaDetailView.as_view()),
    ...
    path('api_eliminar_solicitud_campanya/<int:pk>/', views.SolicitudCampanyaDetailView.as_view()),
